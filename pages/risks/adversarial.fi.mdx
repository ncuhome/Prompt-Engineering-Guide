...
Voit kokeilla tätä esimerkkiä tässä [Notebook-ympäristössä](https://github.com/ncuhome/Prompt-Engineering-Guide/blob/main/notebooks/pe-chatgpt-adversarial.ipynb)-ympäristössä. 
