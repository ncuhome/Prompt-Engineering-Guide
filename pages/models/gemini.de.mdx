...
Gemini Ultra erreicht die höchste Genauigkeit in Kombination mit Ansätzen wie [Chain-of-Thought (CoT) Prompting](/techniques/cot) und [Selbstkonsistenz](/techniques/consistency), die dabei helfen, die Unsicherheit des Modells zu bewältigen.
