...
Notably, Llama 3 8B (instruction-tuned) outperforms [Gemma 7B](/models/gemma) and [Mistral 7B Instruct](/models/mistral-7b). Llama 3 70 broadly outperforms [Gemini Pro 1.5](/models/gemini-pro) and [Claude 3 Sonnet](/models/claude-3) and falls a bit behind on the MATH benchmark when compared to Gemini Pro 1.5.
