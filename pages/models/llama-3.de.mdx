...
Auffällig ist, dass Llama 3 8B (anweisungsoptimiert) [Gemma 7B](/models/gemma) und [Mistral 7B Instruct](/models/mistral-7b) übertrifft. Llama 3 70 übertrifft deutlich [Gemini Pro 1.5](/models/gemini-pro) und [Claude 3 Sonnet](/models/claude-3), bleibt jedoch beim MATH-Benchmark etwas hinter Gemini Pro 1.5 zurück.
