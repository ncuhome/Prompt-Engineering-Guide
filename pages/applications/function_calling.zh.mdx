...
这里有一个 [python notebook](https://github.com/ncuhome/Prompt-Engineering-Guide/blob/main/notebooks/pe-function-calling.ipynb)，它提供了一个简单示例，展示了如何使用 OpenAI API 进行函数调用。
