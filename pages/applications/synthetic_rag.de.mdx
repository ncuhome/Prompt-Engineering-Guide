# Erzeugen von Daten mit LLM für das Training neuer LLM/Ablauf/anderer Modelle
...
Einer der aufkommenden Ansätze ist [Retrieval Augmented Generation (RAG)](/techniques/rag). Es wird für wissensintensive Aufgaben verwendet, bei denen man sich nicht allein auf das Wissen des Modells verlassen kann. RAG kombiniert eine Informationswiederfindungskomponente mit einem Textgenerierungsmodell. Um mehr über diesen Ansatz zu erfahren, lesen Sie bitte [den entsprechenden Abschnitt im Leitfaden](/techniques/rag).
