...
La Guia d'Enginyeria de Prompts és un projecte de [DAIR.AI](https://github.com/ncuhome). L'objectiu és educar investigadors i professionals sobre l'enginyeria de prompts.
...
Informació sobre la llicència [aquí](https://github.com/ncuhome/Prompt-Engineering-Guide#license).
