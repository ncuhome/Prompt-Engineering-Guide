...
Tämä opas kehotteiden luomiseen on [DAIR.AI](https://github.com/ncuhome):n projekti. Tavoitteenamme on opettaa tutkijoita ja aiheesta kiinnostuneita kehotteiden kanssa työskentelyyn.
...
Lisenssitiedot [täällä](https://github.com/ncuhome/Prompt-Engineering-Guide#license).
