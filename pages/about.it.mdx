...
Prompt Engineering Guide è un progetto di [DAIR.AI](https://github.com/ncuhome). Lo scopo è quello di educare ricercatori e professionisti sul prompt engineering (ingegneria dei prompt).
...
Le informazioni sulla licenza sono disponibili [qui] (https://github.com/ncuhome/Prompt-Engineering-Guide#license).
