...
Gemini Ultra achieves highest accuracy when combined with approaches like [chain-of-thought (CoT) prompting](/techniques/cot) and [self-consistency](/techniques/consistency) which helps dealing with model uncertainty. 
