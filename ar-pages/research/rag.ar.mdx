...
As better introduced [here](/techniques/rag), RAG can be defined as:
...
While RAG has also involved the optimization of pre-training methods, current approaches have largely shifted to combining the strengths of RAG and powerful fine-tuned models like [ChatGPT](/models/chatgpt) and [Mixtral](/models/mixtral). The chart below shows the evolution of RAG-related research:
